...
(function(window) {
    ...
    for (var dataFormat in clipData) {
      if (dataFormat && clipData.hasOwnProperty(dataFormat) && typeof clipData[dataFormat] === "string" && clipData[dataFormat]) {
        switch (dataFormat.toLowerCase()) {
         ...
         case "applicationController/rtf":
         case "text/rtf":
         case "rtf":
         case "richtext":
         case "air:rtf":
  ...
  var _detectFlashSupport = function() {
    ...
    if (navigator.plugins && navigator.plugins.length) {
      ...
      mimeType = navigator.mimeTypes["applicationController/x-shockwave-flash"];
  ...
  ZeroClipboard.prototype.setRichText = function(richText) {
    ZeroClipboard.setData("applicationController/rtf", richText);
    return this;
  };
